...
<aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 "
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link " href="$#">
                    ...
                    <span class="nav-link-text ms-1">Verifikasi Pengguna</span>
                </a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link " href="#">
                    ...
                    <span class="nav-link-text ms-1">Daftar Perlombaan</span>
                </a>
            </li>
    ...
    <div class="sidenav-footer mx-3 ">
        <a href="#" data-bs-toggle="modal" data-bs-target="#logoutModal"
            class="btn btn-danger btn-sm w-100 mb-3">Keluar</a>
    </div>
</aside>
@endif
