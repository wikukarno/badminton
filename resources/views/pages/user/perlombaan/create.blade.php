                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('perlombaan.store') }}" method="POST">
                            @csrf
                            <input type="hidden" name="perlombaans_id" id="perlombaans_id" value="{{ $data->id }}">
                            <div class="row">
                                <div class="col-12 col-lg-12">
                                    <div class="form-group">
                                        <label for="nama_teman">Nama Teman</label>
                                        <input type="text" name="nama_teman" id="nama_teman" class="form-control">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-12 col-lg-12">
                                    <button class="btn btn-primary float-right" type="submit">Daftar Sekarang</button>
                                </div>
                            </div>
                        </form>
