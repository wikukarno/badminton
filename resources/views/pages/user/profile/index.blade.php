                    ...
                    <div class="card-body">
                        ...
                        <section class="section-profile-content">
                            <form action="#" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="col-12 col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="tempat_lahir"
                                                name="tempat_lahir" value="{{ $users->tempat_lahir ?? '' }}" readonly>
                                        </div>
                                    </div>
                                    <div class="col-12 col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="tanggal_lahir"
                                                name="tanggal_lahir" value="{{ $users->tanggal_lahir ?? '' }}" readonly>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-12 col-lg-6">
                                        <a href="{{ route('1.dashboard') }}"
                                            class="btn btn-danger btn-block mb-3">Kembali</a>
                                    </div>
                                    <div class="col-12 col-lg-6">
                                        <a href="{{ route('akun.edit', $users->id) }}"
